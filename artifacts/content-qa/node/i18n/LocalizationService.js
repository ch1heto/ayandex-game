...
exports.t = exports.localizationService = void 0;
const contentTranslations_1 = require("./contentTranslations");
const STORAGE_KEY = 'ashvale-language';
const dictionaries = {
    ru: {
        ...contentTranslations_1.contentTranslations.ru,
    ...
    en: {
        ...contentTranslations_1.contentTranslations.en,
...
class LocalizationService {
    ...
    get language() { return this.activeLanguage; }
    ...
    t(key, values = {}) {
        let result = dictionaries[this.activeLanguage][key];
...
const t = (key, values) => exports.localizationService.t(key, values);
exports.t = t;
